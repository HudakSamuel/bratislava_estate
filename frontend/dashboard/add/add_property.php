...
<html>
    <head>
        ...
        <link rel="stylesheet" href="styles_add_property.css?version=51" type="text/css"/>
        <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;400;500;600;700&display=swap" rel="stylesheet"/> 
        <link href="https://fonts.googleapis.com/css2?family=Open+Sans&display=swap" rel="stylesheet"/>       
        <link href="https://fonts.googleapis.com/css2?family=Lato&display=swap" rel="stylesheet"/> 

        <title>Pridať nehnutelnosť</title>
    </head>
            ...
            <div class="right-side">
                ...
                <div class="property-input-container">
                    <form class="property-input-form" action="<?php PropertyController::createPost(); ?>" method="post"enctype="multipart/form-data">
                        ...
                        <div class="form-control">
                            <label class="input-label" for="propertyBody">Popis nehnutelnosti</label>
                            <textarea name="propertyBody" id="propertyBody"><?php echo $savedBody ?></textarea><br>
                        ...
                        <label class="input-label" for="propertyType">Typ nehnutelnosti</label>
                        <select name="propertyType">
                            <option value="Dom">Dom</option>
                            <option value="Byt">Byt</option>
                        </select>

                        <label class="input-label" for="rentBuy">Typ ponuky</label>
                        <select name="rentBuy">
                            <option value="Na prenájom">Na Prenájom</option>
                            <option value="Na predaj">Na predaj</option>
                        </select>

                        <label class="input-label" for="propertyLocation">Lokalita</label>
                        ...
                        <ul>
                            ...
                            <li>
                                <label class="input-label" for="bathrooms">Počet kúpelní</label>
                                <input class="rooms" type="number" name="bathrooms" min="1" max="10" value="<?php echo $savedBathrooms ?>" required>
                            </li>
                        </ul>
                        ...
                        <div class="submit-button">
                            <input type="submit"  name="createPost" value="Potvrdiť">
                        </div>
